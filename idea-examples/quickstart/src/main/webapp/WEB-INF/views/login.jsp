...
<body>
	...
	<div class="content">
		<div id="login-wrap" class="login-static">
			...
			<form id="login-form" name="login-form" method="post" action="${ctx}/login" class="form clr style-type-vertical lang-vertical">
				...
				<div id="login-content" class="form clr">
					<dl>
						<dt class="fm-label">
							<div class="fm-label-wrap clr">
								<span id="login-id-label-extra" class="fm-label-extra"></span> <label for="fm-login-id">账户:</label>
							</div>
						</dt>
						<dd id="fm-login-id-wrap" class="fm-field">
							<div class="fm-field-wrap">
								<input id="fm-login-id" class="fm-text" name="username" tabindex="1" placeholder="账户" value="${auth_username_value}" autocomplete="off" autocorrect="off" autocapitalize="off" />
							</div>
						</dd>
					</dl>
					<dl>
						...
						<dd id="fm-login-password-wrap" class="fm-field">
							<div class="fm-field-wrap">
								<input id="fm-login-password" class="fm-text" type="password" name="password" tabindex="2" autocomplete="off" placeholder="密码" autocorrect="off" autocapitalize="off" />
							</div>
						</dd>
					</dl>
					...
					<dl>
						...
						<dd id="fm-login-captcha-wrap" class="fm-field">
							<div class="fm-field-wrap">
								<input id="fm-login-captcha" class="fm-text" type="text" name="captcha" tabindex="3" autocomplete="off" placeholder="验证码" autocorrect="off" autocapitalize="off" style="width: 100px; margin-right: 10px;" />
								<img style="cursor: pointer;margin-top: 5px;margin-left: 5px" alt="验证码" src="${ctx}/static/images/captcha_placeholder.jpg" title="看不清？点击刷新" id="img_captcha" onclick="javascript:refreshCaptcha();" />
							</div>
						</dd>
					</dl>
					</c:if>
				...
				<div id="login-submit">
					<input id="fm-login-submit" value="登录" class="fm-button fm-submit" type="submit" tabindex="3" name="submit-btn" />
				</div>
			</form>
		</div>
	</div>
